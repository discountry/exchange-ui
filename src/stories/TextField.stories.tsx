...
const TextFieldWithTheme = ({
  ...
  return (
    <ThemeProvider value={{ theme: mode }}>
      <div className="eui-flex eui-flex-col eui-gap-2">
        ...
        <TextField variant="outlined" className="eui-h-[30px] eui-w-24" />
      </div>
    </ThemeProvider>
  );
};
...
export const All: Story = {
  render: () => {
    ...
    return (
      ...
      <form
        className="eui-flex eui-max-w-sm eui-flex-col eui-gap-4"
